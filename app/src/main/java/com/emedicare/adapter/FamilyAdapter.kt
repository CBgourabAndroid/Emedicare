...
class FamilyAdapter (val context: Context, var listItemsTxt: List<Record>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        vh.label.text = listItemsTxt.get(position).patientname+" "+listItemsTxt.get(position).familyname
        return view
    }
